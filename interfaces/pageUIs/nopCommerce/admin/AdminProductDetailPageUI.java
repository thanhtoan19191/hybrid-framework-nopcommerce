...
public class AdminProductDetailPageUI {
	...
	public static final String ALT_TEXTBOX_ADD_NEW_BY_FILE_NAME="xpath=//input[@id='AddPictureModel_OverrideAltAttribute']";
	public static final String TITLE_TEXTBOX_ADD_NEW_BY_FILE_NAME="xpath=//input[@id='AddPictureModel_OverrideTitleAttribute']";
	public static final String DISPLAY_ORDER_TEXTBOX_UP_DOWN="xpath=//input[@id='AddPictureModel_DisplayOrder']/following-sibling::span/span[@aria-lable='%s value']";
